...
# Create I2C bus.
i2c = busio.I2C(board.SCL_1, board.SDA_1) #bus0
i2c2 = busio.I2C(board.SCL, board.SDA) #bus1 (default)
...
while True:
    ...
    # Delay for a second.
    print("Range: {0}mm".format(range_mm),"Range: {0}mm".format(vl53.range))
    time.sleep(1.0)
